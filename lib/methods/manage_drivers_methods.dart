...
class ManageDriversMethods {
  ...
  static void removeDriverFromList(String driverID) {
    int index = nearbyOnlineDriversList
        .indexWhere((driver) => driver.uidHospitalDriver == driverID);
  ...
  static void updateOnlineNearbyDriversLocation(
      OnlineNearbyHospitalsDrivers nearbyOnlineDriverInformation) {
    int index = nearbyOnlineDriversList.indexWhere((driver) =>
        driver.uidHospitalDriver ==
        nearbyOnlineDriverInformation.uidHospitalDriver);

    nearbyOnlineDriversList[index].latHospitalDriver =
        nearbyOnlineDriverInformation.latHospitalDriver;
    nearbyOnlineDriversList[index].lngHospitalDriver =
        nearbyOnlineDriverInformation.lngHospitalDriver;
  }
}
